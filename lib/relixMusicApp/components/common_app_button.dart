  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: onPressed, // Check if onPressed callback is properly assigned
        ...
        child: Text(
          btnText.validate(), // Ensure text is correctly displayed
          style: primaryTextStyle(color: textColor ?? whiteColor), // Check text style
        ),
      ),
    );
  }
